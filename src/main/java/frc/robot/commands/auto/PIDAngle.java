...
public class PIDAngle extends TeleopCommand {
    ...
    public PIDAngle(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, BooleanSupplier flip, double ap, double ai, double ad, Translation2d translation) {
